...
\resumeItemListStart{
  \resumeItem{Languages: C\#, JavaScript/TypeScript, HTML/CSS}
  \resumeItem{Tools: Git/GitHub, VS Code, IntelliJ GoLand/IDEA}
  \resumeItem{Frameworks:.NET Framework, .NET Core, React/Next, MVC, Blazor}
  \resumeItem{Libraries: Entity Framework, React, NextJS}
  \resumeItem{Backend: .NET, ASP.NET Core, Web API}
}\resumeItemListEnd{}
